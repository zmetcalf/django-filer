...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FavoriteFolder'
        db.create_table('filer_favoritefolder', (
            ('id', orm['filer.favoritefolder:id']),
            ('user', orm['filer.favoritefolder:user']),
            ('folder', orm['filer.favoritefolder:folder']),
        ))
        db.send_create_signal('filer', ['FavoriteFolder'])
        
        # Creating unique_together for [user, folder] on FavoriteFolder.
        db.create_unique('filer_favoritefolder', ['user_id', 'folder_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [user, folder] on FavoriteFolder.
        db.delete_unique('filer_favoritefolder', ['user_id', 'folder_id'])
        
        # Deleting model 'FavoriteFolder'
        db.delete_table('filer_favoritefolder')
    ...
    models = {
        ...
        'filer.favoritefolder': {
            'Meta': {'unique_together': "(('user', 'folder'),)"},
